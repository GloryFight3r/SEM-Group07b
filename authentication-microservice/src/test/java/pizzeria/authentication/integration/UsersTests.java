package pizzeria.authentication.integration;
...
import pizzeria.authentication.domain.user.PasswordHashingService;
import pizzeria.authentication.domain.user.UserRepository;
import pizzeria.authentication.integration.utils.JsonUtil;
...
public class UsersTests {
    ...
    public void register_withValidData_worksCorrectly() throws Exception {
        ...
        final AppUser.Role role = AppUser.Role.CUSTOMER;
